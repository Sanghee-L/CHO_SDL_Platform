"""
generate_synthetic_cld.py - Generate a synthetic Cell Line Development (CLD) dataset for testing and development of the CHO SDL platform.
...
def main() -> None:
    ...
    schema_path = root / "data" / "sql" / "create_cld_schema.sql"
